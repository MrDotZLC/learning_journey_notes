...
> (\tilde{O}_b) **不是** attention 输出，  
> 它只是 softmax 分子的“一部分”。

---

## 3. 在线（online）合并所有 block
...
\frac{\sum_{\text{all } j} e^{x_j} V_j}{\sum_{\text{all } j} e^{x_j}}  
]

也就是说：

> **Flash Attention 始终在做“一次全局 softmax”，  
> 只是分多步完成**
...
如果你愿意，下一步我可以把这份内容  
👉 **压缩成一页“逻辑因果图”或“公式—工程对照表”**，非常适合复习和讲解。